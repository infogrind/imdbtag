...
# Here we just print everything, for learning purposes
print("Here's how sabnzbd calls the autoprocess script:")
for i in range(0, 8):
    print("- sys.argv[%d] = " % i + sys.argv[i])
print("""
Note that in the current version, this script is not doing anything,
other than printing the arguments.
    """)
